# 2.3 在 Linux 上安装 Go
-----------------------------------------------------------------------------------------------------------
20170407 在 CentOS 上安装Go, 非常简单， yum install go, 按y , 继续。一路安装，然后使用。下面的内容，需要更新了。
![CentOS安装Go](https://github.com/itbj/the-way-to-go_ZH_CN/blob/master/images/2.3-CentOS-Install-Go.png)
-----------------------------------------------------------------------------------------------------------
